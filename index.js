...
function getFlavorByIndex(originalFlavors,numbers){
    return originalFlavors[numbers];
}
    console.log(getFlavorsByIndex(orginalFlavors,2));
...
function removeFlavorByName(originalFlavors,flavor){
    ...
    for (let i = 0; i < originalFlavors.length; i++){
        if (originalFlavors[i]!==flavor){
            newArray.push(orginalFlavors[i])
        }
    }
    return newArray
}
